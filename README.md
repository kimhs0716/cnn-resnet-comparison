...
**Augmentation 없이는 PlainCNN이 우세하나, augmentation 적용 시 ResNet이 역전된다. 깊이 확장 효과는 데이터셋에 따라 다르게 나타난다.**
...
- **CIFAR-100에서는 shallow에서 ResNet 우위가 더 큼** (+2.10%p → +1.86%p) — 복잡한 태스크에서는 residual connection이 shallow에서도 효과적
